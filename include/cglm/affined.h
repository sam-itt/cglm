...
/*
 Functions:
   CGLM_INLINE void glm_translated(mat4d m, vec3d v);
...
#ifndef cglm_affined_h
#define cglm_affined_h
...
CGLM_INLINE
void
glm_translated(mat4d m, vec3d v) {
  ...
  glm_vec4d_scale(m[0], v[0], v1);
  glm_vec4d_scale(m[1], v[1], v2);
  glm_vec4d_scale(m[2], v[2], v3);

  glm_vec4d_add(v1, m[3], m[3]);
  glm_vec4d_add(v2, m[3], m[3]);
  glm_vec4d_add(v3, m[3], m[3]);
#endif
}
