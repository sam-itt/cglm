...
/*
 ...
 Functions:
   CGLM_INLINE void   glm_vec4d_copy(vec4d v, vec4d dest);
   CGLM_INLINE double glm_vec4d_dot(vec4d a, vec4d b);
   CGLM_INLINE double glm_vec4d_norm2(vec4d v);
   CGLM_INLINE double glm_vec4d_norm(vec4d v);
   CGLM_INLINE void   glm_vec4d_add(vec4d a, vec4d b, vec4d dest);
   CGLM_INLINE void   glm_vec4d_scale(vec4d v, double s, vec4d dest);
   CGLM_INLINE void   glm_vec4d_negate_to(vec4d v, vec4d dest)
...
#define GLM_VEC4D_ONE_INIT   {1.0, 1.0, 1.0, 1.0}
#define GLM_VEC4D_BLACK_INIT {0.0, 0.0, 0.0, 1.0}
#define GLM_VEC4D_ZERO_INIT  {0.0, 0.0, 0.0, 0.0}

#define GLM_VEC4D_ONE        ((vec4)GLM_VEC4D_ONE_INIT)
#define GLM_VEC4D_BLACK      ((vec4)GLM_VEC4D_BLACK_INIT)
#define GLM_VEC4D_ZERO       ((vec4)GLM_VEC4D_ZERO_INIT)
...
CGLM_INLINE
void
glm_vec4d_copy(vec4d v, vec4d dest) {
...
CGLM_INLINE
double
glm_vec4d_dot(vec4d a, vec4d b) {
#if 0 && defined(CGLM_SIMD)
...
CGLM_INLINE
double
glm_vec4d_norm2(vec4d v) {
  return glm_vec4d_dot(v, v);
}
...
CGLM_INLINE
double
glm_vec4d_norm(vec4d v) {
#if 0 && defined(CGLM_SIMD)
  return glmm_norm(glmm_load(v));
#else
  return sqrtf(glm_vec4d_dot(v, v));
#endif
}
...
CGLM_INLINE
void
glm_vec4d_add(vec4d a, vec4d b, vec4d dest) {
#if 0 && (defined( __SSE__ ) || defined( __SSE2__ ))
...
CGLM_INLINE
void
glm_vec4d_scale(vec4d v, double s, vec4d dest) {
#if 0 && (defined( __SSE__ ) || defined( __SSE2__ ))
